...
export const baseClasses = 'inline-flex items-center justify-center rounded-geist font-medium transition-all focus:outline-none focus:ring-2 focus:ring-ds-blue-700/40 disabled:opacity-50 disabled:pointer-events-none active:scale-[0.98]';
